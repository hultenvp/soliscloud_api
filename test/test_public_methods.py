...
async def test_collector_list_valid(api_instance, patched_api):
    ...
    patched_api._get_records.assert_called_with(
        ...
        KEY,
        SECRET,
        {'pageNo': 4, 'pageSize': 100, 'stationId': 1000, 'nmiCode': 'nmi_code'}
    )
...
async def test_inverter_alarm_list_valid(api_instance, patched_api):
    ...
    patched_api._get_records.assert_called_with(
        ...
        KEY,
        SECRET,
        {'pageNo': 1, 'pageSize': 20, 'stationId': '1000', 'alarmBeginTime': '2022-01-01', 'alarmEndTime': '2023-01-01'}
    )
    ...
    patched_api._get_records.assert_called_with(
        ...
        KEY,
        SECRET,
        {'pageNo': 1, 'pageSize': 20, 'alarmDeviceSn': '1000', 'alarmBeginTime': '2022-01-01', 'alarmEndTime': '2023-01-01'}
    )
